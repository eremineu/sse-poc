...
/** A tag or category that can be assigned to users */
...
/** A message sent through the SSE stream */
 ...
 *
 * Server-Sent Events Gadget Backend API
 */
export class Api<
...
> extends HttpClient<SecurityDataType> {
  stream = {
     ...
     * @request GET:/stream
     */
    streamList: (params: RequestParams = {}) =>
      this.request<ModelsMessage[], any>({
        path: `/stream`,
        method: "GET",
